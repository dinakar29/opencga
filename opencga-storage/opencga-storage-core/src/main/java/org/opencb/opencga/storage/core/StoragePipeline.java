 ...
 *
 */
public interface StoragePipeline extends AutoCloseable {
     ...
     */
    URI extract(URI input, URI ouput) throws StorageEngineException;
    ...
    URI preLoad(URI input, URI output) throws IOException, StorageEngineException;
    ...
    @Override
    default void close() throws StorageEngineException {}
